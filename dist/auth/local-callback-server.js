...
function applyCallbackCors(req, res, allowedOrigin) {
...
export function createCallbackServer(context) {
    const server = http.createServer((req, res) => {
        if (!applyCallbackCors(req, res, context.allowedOrigin))
            return;
