...
export type AgentTarget = {
  ...
  detected: boolean;
  /** Initial content for a new file, before the block. */
  newFilePrefix?: string;
};

type TargetEnv = { home: string; cwd: string; codexHome?: string };
 ...
 */
export function agentTargets(env: TargetEnv): AgentTarget[] {
